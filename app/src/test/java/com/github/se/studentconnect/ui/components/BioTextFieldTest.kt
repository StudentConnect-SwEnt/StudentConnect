...
class BioTextFieldTest {
  ...
  fun bioTextField_displaysCharacterCount() {
    composeTestRule.setContent {
      MaterialTheme { BioTextField(value = "Hello", onValueChange = {}, showCharacterCount = true) }
    }
  ...
  fun bioTextField_hidesCharacterCountWhenDisabled() {
    composeTestRule.setContent {
      MaterialTheme {
        BioTextField(value = "Hello", onValueChange = {}, showCharacterCount = false)
      }
    }
  ...
  fun bioTextField_updatesCharacterCountWhenTextChanges() {
    composeTestRule.setContent {
      ...
      MaterialTheme {
        BioTextField(value = value, onValueChange = { value = it }, showCharacterCount = true)
      }
    }
  ...
  fun bioTextField_outlinedStyleWorks() {
    composeTestRule.setContent {
      MaterialTheme {
        BioTextField(value = "Test", onValueChange = {}, style = BioTextFieldStyle.Outlined)
      }
    }
  ...
  fun bioTextField_borderedStyleWorks() {
    composeTestRule.setContent {
      MaterialTheme {
        BioTextField(value = "Test", onValueChange = {}, style = BioTextFieldStyle.Bordered)
      }
    }
  ...
  fun bioTextField_respectsMinLines() {
    composeTestRule.setContent {
      MaterialTheme { BioTextField(value = "Short", onValueChange = {}, minLines = 6) }
    }
  ...
  fun bioTextField_respectsMaxLines() {
    composeTestRule.setContent {
      MaterialTheme { BioTextField(value = "Text", onValueChange = {}, maxLines = 8) }
    }
  ...
  fun bioTextField_displaysCorrectCharacterCountWithUnicode() {
    composeTestRule.setContent {
      MaterialTheme {
        BioTextField(value = "Hello 👋", onValueChange = {}, showCharacterCount = true)
      }
    }
  ...
  fun bioTextField_handlesWhitespaceOnly() {
    composeTestRule.setContent {
      MaterialTheme { BioTextField(value = "   ", onValueChange = {}, showCharacterCount = true) }
    }

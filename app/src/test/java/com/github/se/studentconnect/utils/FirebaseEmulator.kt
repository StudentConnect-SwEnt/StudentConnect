...
object FirebaseEmulator {
  ...
  private fun isInAndroidEmulator(): Boolean {
    // In Robolectric tests, Build properties may be null or set to test values
    // Default to false (use localhost) for Robolectric tests
    try {
      ...
      // In Robolectric or other test environments, default to localhost
      return false
    }
  }

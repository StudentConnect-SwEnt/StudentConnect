...
/**
 * Test implementation that reads actual string values from strings.xml. This keeps the tests aligned
 * with the production resources and avoids duplicating message literals in test code.
 */
class TestResourceProvider(
    stringsFile: File = File("app/src/main/res/values/strings.xml")
) {

...
class EventTemplateSelectionScreenTest {
  ...
  fun emptyState_isDisplayed_whenNoEvents() {
    ...
    composeTestRule.setContent { EventTemplateSelectionScreen(navController = mockNavController) }

    // Wait for Empty State
    composeTestRule.waitUntil {
      composeTestRule
          .onAllNodes(hasTestTag(EventTemplateSelectionScreenTestTags.EMPTY_STATE))
          .fetchSemanticsNodes()
          .isNotEmpty()
    }

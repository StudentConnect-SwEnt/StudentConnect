...
class DescriptionScreenTest {
  ...
  @Test
  fun descriptionTopBar_displaysBackButton() {
    composeRule.setContent { AppTheme { DescriptionTopBar(onBackClick = {}, onSkipClick = {}) } }
    composeRule.onNodeWithContentDescription("Back").assertIsDisplayed()
  }

  @Test
  fun continueButton_displaysCorrectly() {
    composeRule.setContent { AppTheme { ContinueButton(onContinueClick = {}) } }
    composeRule.onNodeWithText("Continue").assertIsDisplayed()
    composeRule.onNodeWithContentDescription("Continue").assertIsDisplayed()
  }
  ...
  @Test
  fun descriptionPrompt_displaysCorrectly() {
    composeRule.setContent {
  ...
  @Test
  fun descriptionScreen_honorsBasicModifier() {
    composeRule.setContent {
      AppTheme {
        var text by remember { mutableStateOf("") }
        DescriptionScreen(
  ...
  @Test
  fun descriptionScreen_honorsChainedModifier() {
    composeRule.setContent {
      AppTheme {
        var text by remember { mutableStateOf("") }
        DescriptionScreen(
  ...
  @Test
  fun descriptionContent_honorsBasicModifier() {
    composeRule.setContent {
      AppTheme {
        DescriptionContent(
            description = "Test",
  ...
  @Test
  fun descriptionContent_honorsChainedModifier() {
    composeRule.setContent {
      AppTheme {
        DescriptionContent(

...
class BioTextFieldFirebaseTest : StudentConnectTest() {
  ...
  fun bioTextField_displaysPlaceholder() {
    composeTestRule.setContent {
      AppTheme { BioTextField(value = "", onValueChange = {}, placeholder = "Enter your bio") }
    }
  ...
  fun bioTextField_showsCharacterCount() {
    composeTestRule.setContent {
      AppTheme {
        BioTextField(value = "Hello World", onValueChange = {}, showCharacterCount = true)
      }
    }
  ...
  fun bioTextField_hidesCharacterCountWhenDisabled() {
    composeTestRule.setContent {
      AppTheme {
        BioTextField(value = "Hello World", onValueChange = {}, showCharacterCount = false)
      }
    }
  ...
  fun bioTextField_outlinedStyleWorks() {
    composeTestRule.setContent {
      AppTheme {
        BioTextField(
            value = "Outlined style test", onValueChange = {}, style = BioTextFieldStyle.Outlined)
      }
    }
  ...
  fun bioTextField_borderedStyleWorks() {
    composeTestRule.setContent {
      AppTheme {
        BioTextField(
            value = "Bordered style test", onValueChange = {}, style = BioTextFieldStyle.Bordered)
      }
    }

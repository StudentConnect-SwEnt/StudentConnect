...
class EventTemplateSelectionEndToEndTest : FirestoreStudentConnectTest() {
    ...
    fun endToEnd_createEventFromTemplateFlow() {
        ...
        composeTestRule.waitUntilWithMessage(
            ...
            message = "center add button to be visible") {
        ...
        composeTestRule.waitUntilWithMessage(
            timeoutMillis = 5_000,
            message = "create from template option to be visible") {
            composeTestRule
        ...
        composeTestRule.waitUntilWithMessage(
            timeoutMillis = 10_000,
            message = "template selection list to appear") {
            composeTestRule
        ...
        composeTestRule.waitUntilWithMessage(
            timeoutMillis = 5_000,
            message = "template event card to appear") {
            composeTestRule
                .onAllNodesWithText(templateTitle)
                .fetchSemanticsNodes()
                .isNotEmpty()
        }
        ...
        composeTestRule.waitUntilWithMessage(
            timeoutMillis = 10_000,
            message = "create public event screen to appear") {
            composeTestRule
